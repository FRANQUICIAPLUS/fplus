...
const AboutUsComponent = () => {
  const partners = [
    ...
    },
    {
      ...
      altimagensincolor: "altWappiadsincolor",
      titleimagensincolor: "titleWappiadsincolor",
      imagenconcolor: require("@/assets/img-franquicias/logo_wappiadcolor.png"),
      altimagenconcolor: "altWappiadconcolor",
      titleimagenconcolor: "titleWappiadconcolor",
